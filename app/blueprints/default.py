...
bp_admin.route('/<int:post_id>', methods=['GET'])(admin_controller.showPost)
bp_admin.route('/<int:post_id>/edit', methods=['GET', 'POST'])(admin_controller.updatePost)
bp_admin.route('/<int:post_id>', methods=['DELETE'])(admin_controller.destroyPost)